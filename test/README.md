...
### (1). Deploy RAG-MedQA services and images

[https://RAG-MedQA.io/docs/build_docker_image](https://RAG-MedQA.io/docs/build_docker_image)
...
RAG-MedQA_IMAGE=infiniflow/RAG-MedQA:v0.24.0 #Replace with the image you are using
