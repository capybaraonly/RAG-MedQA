...
def HttpApiAuth(token):
    return RAG-MedQAHttpApiAuth(token)
...
@pytest.fixture(scope="class")
def add_document(HttpApiAuth, add_dataset, RAG-MedQA_tmp_dir):
    dataset_id = add_dataset
    document_ids = bulk_upload_documents(HttpApiAuth, dataset_id, 1, RAG-MedQA_tmp_dir)
