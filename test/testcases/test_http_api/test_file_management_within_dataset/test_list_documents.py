...
class TestDocumentsList:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ({"keywords": ""}, 5),
            ({"keywords": "0"}, 1),
            ({"keywords": "RAG-MedQA_test_upload"}, 5),
            ({"keywords": "unknown"}, 0),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"name": None}, 0, 5, ""),
            ({"name": ""}, 0, 5, ""),
            ({"name": "RAG-MedQA_test_upload_0.txt"}, 0, 1, ""),
            (
                {"name": "unknown.txt"},
                102,
                0,
    ...
    @pytest.mark.parametrize(
        ...
        [
            (lambda r: r[0], "RAG-MedQA_test_upload_0.txt", 0, 1, ""),
            (lambda r: r[0], "RAG-MedQA_test_upload_1.txt", 0, 0, ""),
            (lambda r: r[0], "unknown", 102, 0, "You don't own the document unknown."),
            (
                "id",
                "RAG-MedQA_test_upload_0.txt",
                102,
                0,
