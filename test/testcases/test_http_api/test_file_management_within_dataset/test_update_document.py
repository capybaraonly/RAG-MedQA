...
class TestDocumentsUpdated:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "RAG-MedQA_test_upload_0",
                101,
                "The extension of file can't be changed",
            ),
            (
                "RAG-MedQA_test_upload_1.txt",
                102,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                {"created_by": "RAG-MedQA_test"},
                102,
                "The input parameters are invalid.",
                marks=pytest.mark.skip(reason="issues/6104"),
            ),
            pytest.param(
                {"dataset_id": "RAG-MedQA_test"},
                102,
                "The input parameters are invalid.",
                marks=pytest.mark.skip(reason="issues/6104"),
            ),
            ...
            pytest.param(
                {"source_type": "RAG-MedQA_test"},
                102,
                "The input parameters are invalid.",
                marks=pytest.mark.skip(reason="issues/6104"),
            ),
            pytest.param(
                {"thumbnail": "RAG-MedQA_test"},
                102,
                "The input parameters are invalid.",
                marks=pytest.mark.skip(reason="issues/6104"),
            ),
