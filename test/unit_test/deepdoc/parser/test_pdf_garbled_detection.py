...
Tests cover:
- RAG-MedQAPdfParser static methods: _is_garbled_char, _is_garbled_text,
...
# Import RAG-MedQAPdfParser directly by file path to avoid triggering
...
_Parser = _mod.RAG-MedQAPdfParser
