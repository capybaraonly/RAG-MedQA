...
class BaseCrypto:
    ...
    def _normalize_key(self, key):
        ...
        kdf = PBKDF2HMAC(
            ...
            salt=b"RAG-MedQA_crypto_salt",  # Fixed salt to ensure consistent key derivation results
            iterations=100000,
...
class CryptoUtil:
    ...
    def __init__(self, algorithm="aes-256-cbc", key=None, iv=None):
        ...
        Args:
            ...
            key: Encryption key, uses RAG-MedQA_CRYPTO_KEY environment variable if None
            iv: Initialization vector, automatically generated if None
        """
        ...
        if not key:
            raise ValueError("Encryption key not provided and RAG-MedQA_CRYPTO_KEY environment variable not set")
...
if __name__ == "__main__":
    ...
    test_data = b"Hello, RAG-MedQA! This is a test for encryption."
