...
const llmFactoryToUrlMap: Partial<Record<LLMFactory, string>> = {
  [LLMFactory.Ollama]:
    'https://github.com/infiniflow/RAG-MedQA/blob/main/docs/guides/models/deploy_local_llm.mdx',
  ...
  [LLMFactory.RAGcon]: 'https://www.ragcon.ai/erste-schritte-mit-RAG-MedQA/',
