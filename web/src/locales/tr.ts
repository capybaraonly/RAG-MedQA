...
Örnek: 1024 boyutlu embedding ile 1 KB\'lık bir mesaj ~9 KB kullanır. 5 MB varsayılan sınır ~500 mesaj tutar.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        "RAG-MedQA'nun LLM için hedeflenen içeriği alıp alamadığını kontrol etmek için bir alım testi yapın.",
      Parse: 'Ayrıştır',
      dataset: 'Dataset',
      testing: 'Alım testi',
      files: 'dosyalar',
      ...
      similarityThresholdTip:
        'RAG-MedQA, alım sırasında ağırlıklı anahtar kelime benzerliği ile ağırlıklı vektör kosinüs benzerliğinin veya ağırlıklı yeniden sıralama puanının kombinasyonunu kullanır. Bu parametre, kullanıcı sorgusu ile parçalar arasındaki benzerlik eşiğini belirler. Bu eşiğin altında benzerlik puanına sahip parçalar sonuçlardan çıkarılır. Varsayılan eşik 0.2 olarak ayarlanmıştır, yani yalnızca 20 veya daha yüksek hibrit benzerlik puanına sahip parçalar alınacaktır.',
      ...
      uploadDescription:
        'Tekil veya toplu dosya yüklemeyi destekler. Yerel olarak dağıtılan RAG-MedQA için: yükleme başına toplam dosya boyutu sınırı 1GB, 32 dosyalık toplu yükleme sınırı vardır. Hesap başına toplam dosya sayısında sınır yoktur. cloud.RAG-MedQA.io için yükleme başına toplam dosya boyutu sınırı 10MB, her dosya en fazla 10MB ve hesap başına en fazla 128 dosya.',
      chunk: 'Parça',
      bulk: 'Toplu',
      cancel: 'İptal',
      close: 'Kapat',
      ...
      rerankTip: `İsteğe bağlı. Boş bırakılırsa RAG-MedQA ağırlıklı anahtar kelime benzerliği ve ağırlıklı vektör kosinüs benzerliğinin kombinasyonunu kullanır; yeniden sıralama modeli seçilirse ağırlıklı yeniden sıralama puanı ağırlıklı vektör kosinüs benzerliğinin yerini alır. Yeniden sıralama modeli kullanmanın sistemin yanıt süresini önemli ölçüde artıracağını unutmayın. Yeniden sıralama modeli kullanmak istiyorsanız bir SaaS yeniden sıralayıcı kullandığınızdan emin olun; yerel olarak dağıtılmış yeniden sıralama modelini tercih ediyorsanız RAG-MedQA'u docker-compose-gpu.yml ile başlattığınızdan emin olun.`,
      topK: 'Top-K',
...
`,
      useRaptor: 'RAPTOR',
      useRaptorTip:
        "RAPTOR çok adımlı soru-cevap görevleri için kullanılabilir. Dosyalar sayfasına gidin, Oluştur > RAPTOR'a tıklayarak etkinleştirin. Ayrıntılar için bkz. https://RAG-MedQA.io/docs/dev/enable_raptor.",
      prompt: 'İstem',
      promptTip:
...
Yukarısı özetlemeniz gereken içeriktir.`,
      ...
      pageRankTip: `Alım sırasında belirli datasets'e daha yüksek PageRank puanı atayabilirsiniz. İlgili puan, bu datasetlerden alınan parçaların hibrit benzerlik puanlarına eklenir ve sıralamalarını yükseltir. Ayrıntılar için bkz. https://RAG-MedQA.io/docs/dev/set_page_rank.`,
      tagName: 'Etiket',
      frequency: 'Sıklık',
      ...
      tagSetTip: `
     <p> Dataset'inizdeki parçaları otomatik olarak etiketlemek için bir veya birden fazla etiket dataset seçin. Ayrıntılar için bkz. https://RAG-MedQA.io/docs/dev/use_tag_sets.</p>
...
<ul>
  ...
  <li>Otomatik anahtar kelime özelliği LLM'e bağımlıdır ve önemli miktarda token tüketir.</li>
      ...
      useGraphRagTip:
        'İç içe geçmiş mantık içeren çok adımlı soru-cevabı geliştirmek için mevcut dataset dosya parçaları üzerinde bir bilgi grafiği oluşturun. Ayrıntılar için bkz. https://RAG-MedQA.io/docs/dev/construct_knowledge_graph.',
...
**Temel Kurallar:**
  ...
  - **Her zaman** konuşma geçmişinin tamamını göz önünde bulundurun.`,
      ...
      **Temel Kurallar:**
      ...
      variable: 'Değişken',
      variableTip: `RAG-MedQA\'nun sohbet asistanı yönetim API\'leri ile birlikte kullanılır.`,
      add: 'Ekle',
      key: 'Anahtar',
      ...
      betaError:
        'Lütfen önce Sistem Ayarları sayfasından bir RAG-MedQA API anahtarı edinin.',
      searching: 'Aranıyor...',
    ...
    setting: {
      ...
      embeddingModelTip:
        'Her yeni oluşturulan dataset için varsayılan embedding model. Açılır listede bir embedding model bulamıyorsanız, RAG-MedQA slim sürümünü (embedding modeller içermez) kullanıp kullanmadığınızı kontrol edin veya model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://RAG-MedQA.io/docs/dev/supported_models adresine bakın.',
      img2txtModel: 'VLM',
      img2txtModelTip:
        'Her yeni oluşturulan dataset için varsayılan VLM. Bir resmi veya videoyu tanımlar. Açılır listede bir model bulamıyorsanız, model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://RAG-MedQA.io/docs/dev/supported_models adresine bakın.',
      ...
      rerankModel: 'Rerank',
      rerankModelTip: `Parçaları yeniden sıralamak için varsayılan yeniden sıralama modeli. Açılır listede bir model bulamıyorsanız, model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://RAG-MedQA.io/docs/dev/supported_models adresine bakın.`,
      ttsModel: 'TTS',
      ttsModelTip:
        'Varsayılan metin-konuşma dönüştürme modeli. Açılır listede bir model bulamıyorsanız, model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://RAG-MedQA.io/docs/dev/supported_models adresine bakın.',
    ...
    fileManager: {
      ...
      uploadTitle: 'Yüklemek için dosyanızı buraya sürükleyip bırakın',
      uploadDescription:
        'Tekil veya toplu dosya yüklemeyi destekler. Yerel RAG-MedQA için 1GB sınır, 32 dosya toplu yükleme sınırı.',
