  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'قم بإجراء اختبار استرجاع للتحقق مما إذا كان RAG-MedQA يمكنه استرداد المحتوى المقصود لـ LLM.',
      Parse: 'تحليل',
      dataset: 'مجموعة البيانات',
      ...
      uploadDescription:
        'يدعم تحميل ملف واحد أو دفعي. بالنسبة إلى RAG-MedQA المنشور محليًا: يبلغ الحد الإجمالي لحجم الملف لكل عملية تحميل 1 جيجابايت، مع حد تحميل دفعة يبلغ 32 ملفًا. لا يوجد حد أقصى لإجمالي عدد الملفات لكل حساب. بالنسبة إلى cloud.RAG-MedQA.io، يبلغ الحد الأقصى لحجم الملف الإجمالي لكل عملية تحميل 10 ميجابايت، على ألا يتجاوز كل ملف 10 ميجابايت وبحد أقصى 128 ملفًا لكل حساب.',
      chunk: 'قطعة',
      bulk: 'حجم كبير',
      cancel: 'يلغي',
      close: 'يغلق',
      ...
      rerankTip:
        'خياري. إذا تركت فارغة، فسوف يستخدم RAG-MedQA مجموعة من تشابه الكلمات الرئيسية الموزونة وتشابه جيب التمام المتجه الموزون؛ إذا تم تحديد نموذج إعادة الترتيب، فستحل درجة إعادة الترتيب المرجحة محل تشابه جيب تمام المتجه المرجح. يرجى العلم أن استخدام نموذج إعادة الترتيب سيؤدي إلى زيادة وقت استجابة النظام بشكل كبير. إذا كنت ترغب في استخدام نموذج إعادة الترتيب، فتأكد من استخدام أداة إعادة ترتيب SaaS؛ إذا كنت تفضل نموذج إعادة الترتيب المنشور محليًا، فتأكد من بدء تشغيل RAG-MedQA باستخدام docker-compose-gpu.yml.',
      topK: 'توب ك',
      topKTip:
    ...
    knowledgeConfiguration: {
      ...
      useRaptor: 'رابتور',
      useRaptorTip:
        'يمكن استخدام RAPTOR لمهام الإجابة على الأسئلة متعددة القفزات. انتقل إلى صفحة الملفات، وانقر فوق إنشاء > RAPTOR لتمكينه. راجع https://RAG-MedQA.io/docs/dev/enable_raptor للحصول على التفاصيل.',
      prompt: 'اِسْتَدْعَى',
      promptTip:
      ...
      pageRankTip:
        'يمكنك تعيين درجة أعلى لتصنيف الصفحات لقواعد معرفية محددة أثناء الاسترجاع. تتم إضافة النتيجة المقابلة إلى درجات التشابه الهجينة للأجزاء المستردة من قواعد المعرفة هذه، مما يؤدي إلى زيادة ترتيبها. راجع https://RAG-MedQA.io/docs/dev/set_page_rank للحصول على التفاصيل.',
      tagName: 'علامة',
      frequency: 'تكرار',
    ...
    chat: {
      ...
      variable: 'عامل',
      variableTip:
        'عند استخدامها مع واجهات برمجة تطبيقات إدارة مساعد الدردشة الخاصة بـ RAG-MedQA، يمكن للمتغيرات أن تساعد في تطوير إستراتيجيات موجهة للنظام أكثر مرونة. سيتم استخدام المتغيرات المحددة بواسطة "موجه النظام" كجزء من المطالبات الخاصة بـ LLM. {knowledge} هو متغير خاص محجوز يمثل الأجزاء المستردة من قاعدة (قواعد) المعرفة المحددة، ويجب وضع جميع المتغيرات بين قوسين متعرجين {} في "موجه النظام". راجع https://RAG-MedQA.io/docs/dev/set_chat_variables للحصول على التفاصيل.',
      add: 'يضيف',
      key: 'مفتاح',
      optional: 'خياري',
      operation: 'عملية',
      ...
      betaError:
        'يرجى الحصول على مفتاح RAG-MedQA API من صفحة إعدادات النظام أولاً.',
    ...
    setting: {
      ...
      embeddingModelTip:
        'نموذج التضمين الافتراضي لكل قاعدة معرفية تم إنشاؤها حديثًا. إذا لم تتمكن من العثور على نموذج التضمين من القائمة المنسدلة، فتحقق مما إذا كنت تستخدم إصدار RAG-MedQA النحيف (الذي لا يتضمن نماذج التضمين) أو تحقق من https://RAG-MedQA.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
      img2txtModel: 'VLM',
      img2txtModelTip:
        'VLM الافتراضي لكل قاعدة معارف تم إنشاؤها حديثًا. وهو يصف صورة أو مقطع فيديو. إذا لم تتمكن من العثور على نموذج من القائمة المنسدلة، فراجع https://RAG-MedQA.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
      ...
      rerankModelTip:
        'نموذج إعادة الترتيب الافتراضي لإعادة ترتيب القطع. إذا لم تتمكن من العثور على نموذج من القائمة المنسدلة، فراجع https://RAG-MedQA.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
      ttsModel: 'تحويل النص إلى كلام',
      ttsModelTip:
        'النموذج الافتراضي لتحويل النص إلى كلام. إذا لم تتمكن من العثور على نموذج من القائمة المنسدلة، فراجع https://RAG-MedQA.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
