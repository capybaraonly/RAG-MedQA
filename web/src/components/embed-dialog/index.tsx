      ...
      <DialogContent>
        ...
        <section className="w-full overflow-auto space-y-5 text-sm text-text-secondary">
          ...
          <a
            ...
            href={
              isAgent
                ? 'https://RAG-MedQA.io/docs/dev/http_api_reference#create-session-with-agent'
                : 'https://RAG-MedQA.io/docs/dev/http_api_reference#create-session-with-chat-assistant'
            }
            target="_blank"
            rel="noreferrer"
          >
